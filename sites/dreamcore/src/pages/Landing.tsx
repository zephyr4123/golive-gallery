...
import { NAV_PATHS } from '../components/SiteNav'
...
export default function Landing() {
  ...
  const arcSweepDeg = (VOYAGES.length - 1) * 10
  ...
  return (
    <div ref={containerRef} style={{ height: '480vh', position: 'relative' }}>
      ...
      >
        ...
        >
          <ArcCardSlider cards={VOYAGES} rotationOffset={arcRotationOffset} isMobile={isMobile} />
        </div>
        ...
        >
          {isMobile ? (
            ...
            <div style={{ display: 'flex', gap: 36 }}>
              {['Voyages', 'Atelier', 'Immersions'].map((l) => (
                <Link key={l} to={NAV_PATHS[l]} style={NAV_LINK_STYLE}>
                  {l}
                </Link>
              ))}
            </div>
          ...
          <StarLogo />
          {isMobile ? (
            <span style={{ ...NAV_LINK_STYLE, fontSize: 11 }}>Reserve</span>
          ) : (
            <div style={{ display: 'flex', gap: 36 }}>
        ...
        >
          ...
          <div className="hidden xl:block">
            ...
            >
              ...
              >
                A travel agency that sells dreams — voyages tailored for those who have stayed awake too long.
              </p>
            </div>
            <div
              style={{
            ...
            >
              <PhotoCard image={CARD_IMAGES[0]} to="/immersions" size={158} radius={28} type="play" labelSize={18} numberSize={36} playSize={30} withBlurStrip />
              <PhotoCard image={CARD_IMAGES[1]} to="/voyages" size={158} radius={28} type="number" labelSize={18} numberSize={36} playSize={30} withBlurStrip />
              <PhotoCard image={CARD_IMAGES[2]} to="/immersions" size={158} radius={28} type="play" labelSize={18} numberSize={36} playSize={30} withBlurStrip />
            </div>
          </div>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 14 }}>
              <PhotoCard image={CARD_IMAGES[0]} to="/immersions" size={140} radius={22} type="play" labelSize={14} numberSize={28} playSize={26} withBlurStrip />
              <PhotoCard image={CARD_IMAGES[1]} to="/voyages" size={140} radius={22} type="number" labelSize={14} numberSize={28} playSize={26} withBlurStrip />
              <PhotoCard image={CARD_IMAGES[2]} to="/immersions" size={140} radius={22} type="play" labelSize={14} numberSize={28} playSize={26} withBlurStrip />
            </div>
          </div>
        ...
        >
          <div style={{ marginTop: isMobile ? '8vh' : '12vh', textAlign: 'center', padding: '0 20px' }}>
            ...
            >
              Nine dream routes to astonishing destinations — for those who insist on finding beauty beyond the ordinary and the known.
            </p>
          </div>
        </div>
      </div>
